...
# Removed all custom CSS injections to let Streamlit's native Dark/Light 
# mode handle all UI text perfectly without any CSS conflicts.
...
with tab_predict:
    ...
    if st.button("Predict Performance Index", type="primary", use_container_width=True):
        ...
        with res_col2:
            ...
            # Explicitly force a white figure background
            ...
            # theme=None stops Streamlit from overriding our colors
...
with tab_insights:
    ...
    # Strictly enforce a white background and black text for Seaborn
    ...
    with viz_tab3:
        ...
        with bcol2:
            ...
            fig6, ax6 = plt.subplots(figsize=(6, 4), facecolor='white')
            sns.boxplot(x=df[TARGET], color="#9b59b6", ax=ax6)
            st.pyplot(fig6, theme=None)
